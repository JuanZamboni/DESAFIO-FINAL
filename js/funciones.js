...
function actualizarBotonCarrito() {
    ...
    let contenido = `<button type="button" class="btn btn-primary position-relative"> <img src="imagenes/carro-de-la-carretilla.png" width="24">
    ...
    if (productos.length > 0) {
        ...
        contenido = `<button type="button" class="btn btn-primary position-relative"> <img src="imagenes/carro-de-la-carretilla.png" width="24">
